...
describe('Loading the test database', function() {
    it('should be successful with the password \'123456\'', function(done) {
        ...
        safe.load(psafe3Data, function(err, headerRecord, databaseRecords) {
            ...
            record1.getTitle().should.be.exactly('title2');
            record1.getUsername().should.be.exactly('username2');
            record1.getPassword().should.be.exactly('password2');
            record1.getNotes().should.be.exactly('notes2');
            record1.getUrl().should.be.exactly('url2');
            record1.getEMailAddress().should.be.exactly('email2');
            ...
            var record2 = databaseRecords[1];
            record2.getGroup().should.be.exactly('group');
            record2.getTitle().should.be.exactly('group.title1');
            record2.getUsername().should.be.exactly('group.username1');
            record2.getPassword().should.be.exactly('group.password1');
            record2.getUrl().should.be.exactly('group.url1');
            record2.getEMailAddress().should.be.exactly('group.email1');
            record2.getNotes().should.be.exactly('group.notes1');
            ...
            var record3 = databaseRecords[2];
            (null === record3.getGroup()).should.be.true;
            record3.getTitle().should.be.exactly('title1');
            record3.getUsername().should.be.exactly('username1');
            record3.getPassword().should.be.exactly('password1');
            record3.getNotes().should.be.exactly('notes1');
            record3.getUrl().should.be.exactly('url1');
            record3.getEMailAddress().should.be.exactly('email1');
