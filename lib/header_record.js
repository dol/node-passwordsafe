...
HeaderRecord.prototype.setVersion = function(version) {
    var versionBuffer = Buffer.alloc(2);
    versionBuffer.writeUInt16LE(version, 0);
    return this.rawFields[0x00] = versionBuffer;
};
...
HeaderRecord.prototype.getEmptyGroups = function() {
    ...
    var emptyGroups = [];
    for (var i in this.rawFields[0x11]) {
        emptyGroups.push(this.rawFields[0x11][i].toString('utf-8'));
    }
    return emptyGroups;
};
