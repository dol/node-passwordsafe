...
DatabaseRecord.prototype.setUUID = function(uuid) {
    return this.setUUIDField(0x01, uuid);
};
...
DatabaseRecord.prototype.setGroup = function(group) {
    return this.setTextField(0x02, group);
};
...
DatabaseRecord.prototype.setTitle = function(title) {
    return this.setTextField(0x03, title);
};
...
DatabaseRecord.prototype.setUsername = function(username) {
    return this.setTextField(0x04, username);
};
...
DatabaseRecord.prototype.setPassword = function(password) {
    return this.setTextField(0x06, password);
};
...
DatabaseRecord.prototype.setUrl = function(url) {
    return this.setTextField(0x0d, url);
};
